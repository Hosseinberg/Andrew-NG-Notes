...
- Difference between precision and recall (in cat classification example):
  - Suppose we run the classifier on 10 https://raw.githubusercontent.com/ashishpatel26/DeepLearning.ai-Summary/master/3-%20Structuring%20Machine%20Learning%20Projects/Images/ which are 5 cats and 5 non-cats. The classifier identifies that there are 4 cats, but it identified 1 wrong cat.
  - Confusion matrix:
...
- Sometimes, you can evaluate multiple error analysis ideas in parallel and choose the best idea. Create a spreadsheet to do that and decide, e.g.:
  ...
  | ....         |        |            |         |                   |                |
  | **% totals** | **8%** | **43%**    | **61%** |      **12%**      |                |
- In the last example you will decide to work on great cats or blurry https://raw.githubusercontent.com/ashishpatel26/DeepLearning.ai-Summary/master/3-%20Structuring%20Machine%20Learning%20Projects/Images/ to improve your performance.
